...
export async function uploadDocument(
  ...
  try {
    ...
    console.log(
      `[Upload] Received file: "${file.originalname}" ` +
    ...
    console.log(
      `[Upload] Extracted ${extractedData.totalPages} pages ` +
    ...
    console.log(
      `[Upload] Chunking stats: ${chunkStats.total} chunks, ` +
    ...
    console.log(
      `[Upload] Embedding stats: ${embeddingStats.total} vectors, ` +
    ...
    console.log(
      `[Upload] ✅ Document "${file.originalname}" fully processed`
    );
    ...
    if (documentId) {
      try {
        await updateDocumentStatus(documentId, "error");
        console.error(
          `[Upload] Marked document ${documentId} as error due to failure`
        );
      } catch (updateErr) {
