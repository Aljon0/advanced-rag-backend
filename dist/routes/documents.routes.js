...
import { getDocuments, getDocument, removeDocument, } from "../controllers/documents.controller.js";
const router = Router();
...
router.post("/upload", upload.single("file"), // "file" matches formData.append("file", file)
uploadDocument);
// GET /documents
